export const ChractersInfo = [
  {
    name: "바이퍼병장님",
    job: "바이퍼",
    level: 250,
    imageUrl:
      "https://avatar.maplestory.nexon..png",
    equipments: [
      {
        name: "이터널 플레임 링",
